...
import vn.com.vnpt.vinaphone.vnptsoftware.qlvbdhcaobang.model.pojo.respone.FilterSearch;
...
public class DocumentAdvanceSearchActivity extends BaseActivity implements IFilterSearchView, ILoginView {

    private Toolbar toolbar;
    private ImageView btnBack;
    private boolean more_search;
    @BindView(R.id.btnNgayBHFrom)
    ImageView btnNgayBHFrom;
    @BindView(R.id.btnNgaySTFrom)
    ImageView btnNgaySTFrom;
    @BindView(R.id.btnHanXLFrom)
    ImageView btnHanXLFrom;
    @BindView(R.id.btnNgayBHEnd)
    ImageView btnNgayBHEnd;
    @BindView(R.id.btnNgaySTEnd)
    ImageView btnNgaySTEnd;
    @BindView(R.id.btnHanXLEnd)
    ImageView btnHanXLEnd;
    @BindView(R.id.tv_trichyeu_label)
    ...
    TextView btnCancel;
    @BindView(R.id.layoutMoreSearch)
    LinearLayout layoutMoreSearch;
    @BindView(R.id.checkboxSearch)
...
//        if (tv_y_kien_xl.getText() != null && tv_trichyeu.getText().toString() != null && !tv_trichyeu.getText().toString().equals("")) {
//            documentAdvanceSearchParameter.setTrichYeu(tv_trichyeu.getText().toString());
//        }
        ...
        if (edtIofficeSovb.getText() != null && edtIofficeSovb.getText().toString() != null && !edtIofficeSovb.getText().toString().equals("")) {
            documentAdvanceSearchParameter.setIoffice(edtIofficeSovb.getText().toString());
        }
    ...
    public void showProgress() {
        if (DocumentAdvanceSearchActivity.this.isFinishing()) {
            return;
        }
