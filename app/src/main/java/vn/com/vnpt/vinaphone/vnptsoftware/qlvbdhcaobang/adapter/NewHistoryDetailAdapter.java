                ...
                if (logInfo.getChuyenToi() != null && !logInfo.getChuyenToi().equals("")) {
                    ...
                    try {
                        if (data[1] != null && !data[1].trim().equals("") && data[1].contains(":")) {
                            txtXLC.setText(data[1].split("\\:")[1]);
                            tvXlcLb.setText(data[1].split("\\:")[0] + ":");
                        } else {
                            if (data[1] != null && !data[1].trim().equals("")) {
                                txtXLC.setText(data[1]);
                            } else {
                    ...
                    try {
                        if (data[2] != null && !data[2].trim().equals("") && data[2].contains(":")) {
                            txtPH.setText(data[2].split("\\:")[1]);
                            tvPhLb.setText(data[2].split("\\:")[0] + ":");
                        } else {
                            if (data[2] != null && !data[2].trim().equals("")) {
                                txtPH.setText(data[2]);
                            } else {
                    ...
                    try {
                        if (data[3] != null && !data[3].trim().equals("") && data[3].contains(":")) {
                            txtXem.setText(data[3].split("\\:")[1]);
                            tvXemLb.setText(data[3].split("\\:")[0] + ":");
                        } else {
                            if (data[3] != null && !data[3].trim().equals("")) {
                                txtXem.setText(data[3]);
                            } else {
                    ...
                    try {
                        if (data[4] != null && !data[4].trim().equals("") && data[4].contains(":")) {
                            txtXYK.setText(data[4].split("\\:")[1]);
                            tv_xyk_lb.setText(data[4].split("\\:")[0] + ":");
                        } else {
                            if (data[4] != null && !data[4].trim().equals("")) {
                                txtXYK.setText(data[4]);
                            } else {
