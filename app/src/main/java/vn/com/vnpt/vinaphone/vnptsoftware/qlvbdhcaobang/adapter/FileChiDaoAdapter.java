    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ic_remove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (type.equals("SEND")) {
                    ((SendChiDaoActivity) context).removeFile(attachFileInfo.getName());
                    itemAttackFile.removeAllViews();
                }
                if (type.equals("EDIT")) {
                    ((EditChiDaoActivity) context).removeFile(attachFileInfo.getName());
                    itemAttackFile.removeAllViews();
                }
                if (type.equals("FW")) {
                    ((ForwardChiDaoActivity) context).removeFile(attachFileInfo.getName());
                    itemAttackFile.removeAllViews();
                }
                if (type.equals("REPLY")) {
                    ((ReplyChiDaoActivity) context).removeFile(attachFileInfo.getName());
                    itemAttackFile.removeAllViews();
                }
            }
        });
