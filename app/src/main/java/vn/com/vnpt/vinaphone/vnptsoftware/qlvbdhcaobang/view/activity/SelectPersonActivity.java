...
public class SelectPersonActivity extends BaseActivity implements ISelectPersonView, ILoginView, IFilterPersonView {
...
//            ListPersonEvent listPersonEvent = EventBus.getDefault().getStickyEvent(ListPersonEvent.class);
//            List<Person> personList = listPersonEvent.getPersonGroupList();
//            TypePersonEvent typePersonEvent = EventBus.getDefault().getStickyEvent(TypePersonEvent.class);
//            if (typePersonEvent != null) {
//                switch (typePersonEvent.getType()) {
//                    case Constants.TYPE_SEND_PERSON_PROCESS:
...
//                                boolean check = false;
//                                for (int j = 0; j < listPersonEvent.getPersonProcessList().size(); j++) {
//                                    if (listPersonEvent.getPersonProcessList().get(j).getId().equals(personList.get(i).getId())) {
//                                        listPersonEvent.getPersonProcessList().set(j, personList.get(i));
//                                        check = true;
//                                        break;
//                                    }
//                                }
//                                if (!check) {
//                                    listPersonEvent.getPersonProcessList().add(personList.get(i));
//                                }
//                                if (isLienThong) {
//                                    check = false;
//                                    if (listPersonEvent.getPersonLienThongList() != null) {
//                                        for (int j = 0; j < listPersonEvent.getPersonLienThongList().size(); j++) {
//                                            if (listPersonEvent.getPersonLienThongList().get(j).getId().equals(personList.get(i).getId())) {
//                                                listPersonEvent.getPersonLienThongList().set(j, personList.get(i));
//                                                check = true;
//                                                break;
//                                            }
//                                        }
//                                        if (!check) {
//                                            listPersonEvent.getPersonLienThongList().add(personList.get(i));
//                                        }
//                                    } else {
//                                        List<Person> personListLT = new ArrayList<>();
//                                        for (int j = 0; j <  personList.size(); j++) {
//                                            personListLT.add(personList.get(j));
//                                        }
//                                        listPersonEvent.setPersonLienThongList(personListLT);
//                                    }
//                                }
//                            }
//                        } else {
//                            List<Person> personListGroup = new ArrayList<>();
//                            for (int i = 0; i <  personList.size(); i++) {
//                                personListGroup.add(personList.get(i));
//                            }
//                            listPersonEvent.setPersonProcessList(personListGroup);
//                            if (isLienThong) {
//                                boolean check = false;
//                                if (listPersonEvent.getPersonLienThongList() != null) {
//                                    for (int i = 0; i < personList.size(); i++) {
...
//                            for (int i = 0; i <  personList.size(); i++) {
//                                boolean check = false;
//                                for (int j = 0; j < listPersonEvent.getPersonDirectList().size(); j++) {
//                                    if (listPersonEvent.getPersonDirectList().get(j).getId().equals(personList.get(i).getId())) {
//                                        listPersonEvent.getPersonDirectList().set(j, personList.get(i));
//                                        check = true;
//                                        break;
//                                    }
//                                }
//                                if (!check) {
//                                    listPersonEvent.getPersonDirectList().add(personList.get(i));
//                                }
//                                if (isLienThong) {
//                                    check = false;
//                                    if (listPersonEvent.getPersonLienThongList() != null) {
...
//                                personListGroup.add(personList.get(i));
//                            }
//                            listPersonEvent.setPersonDirectList(personListGroup);
//                            if (isLienThong) {
//                                boolean check = false;
//                                if (listPersonEvent.getPersonLienThongList() != null) {
//                                    for (int i = 0; i < personList.size(); i++) {
...
//                            for (int i = 0; i <  personList.size(); i++) {
//                                boolean check = false;
//                                for (int j = 0; j < listPersonEvent.getPersonNotifyList().size(); j++) {
//                                    if (listPersonEvent.getPersonNotifyList().get(j).getId().equals(personList.get(i).getId())) {
//                                        listPersonEvent.getPersonNotifyList().set(j, personList.get(i));
//                                        check = true;
//                                        break;
//                                    }
//                                }
//                                if (!check) {
//                                    listPersonEvent.getPersonNotifyList().add(personList.get(i));
//                                }
//                            }
//                        } else {
//                            List<Person> personListGroup = new ArrayList<>();
...
//                                personListGroup.add(personList.get(i));
//                            }
//                            listPersonEvent.setPersonNotifyList(personListGroup);
//                        }
//                        break;
//                    default:
//                        break;
