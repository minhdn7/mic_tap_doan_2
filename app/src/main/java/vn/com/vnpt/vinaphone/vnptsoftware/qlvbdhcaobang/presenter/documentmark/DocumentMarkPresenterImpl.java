...
import vn.com.vnpt.vinaphone.vnptsoftware.qlvbdhcaobang.view.viewevent.IDetailDocumentMarkView;
import vn.com.vnpt.vinaphone.vnptsoftware.qlvbdhcaobang.view.viewevent.IDocumentDiagramView;
import vn.com.vnpt.vinaphone.vnptsoftware.qlvbdhcaobang.view.viewevent.IDocumentMarkView;
    ...
    public void onCallSuccess(Object object) {
        if (object instanceof CountDocumentMarkRespone) {
            ...
            if (countDocumentMarkRespone.getResponeAPI().getCode().equals(Constants.RESPONE_SUCCESS)) {
                ...
                documentMarkView.onError(new APIError(0, "Có lỗi xảy ra!\nVui lòng thử lại sau!"));
            }
        }
        ...
        if (object instanceof DetailDocumentMarkRespone) {
            ...
            if (detailDocumentMarkRespone != null && detailDocumentMarkRespone.getResponeAPI().getCode().equals(Constants.RESPONE_SUCCESS)) {
                ...
                detailDocumentMarkView.onError(new APIError(0, "Có lỗi xảy ra!\nVui lòng thử lại sau!"));
            }
        }
