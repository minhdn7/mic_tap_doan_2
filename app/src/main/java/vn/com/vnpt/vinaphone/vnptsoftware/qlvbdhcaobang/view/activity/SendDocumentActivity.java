...
import vn.com.vnpt.vinaphone.vnptsoftware.qlvbdhcaobang.adapter.PersonProcessAdapter;
...
//                }
    ...
    private void send() {
        ...
        if (type == Constants.TYPE_SEND_NOTIFY || type == Constants.TYPE_SEND_PROCESS) {
            ...
            TypeChangeEvent typeChangeEvent = EventBus.getDefault().getStickyEvent(TypeChangeEvent.class);
            List<TypeChangeDocument> typeChangeDocumentList = typeChangeEvent.getTypeChangeDocumentList();
            if (typeChangeDocumentList.get(selected - 1).getNextStep().equals("get_cleck_publish") && (typeChangeDocumentRequest.getType().equals(Constants.DOCUMENT_RECEIVE) ||
    ...
    public void addPerson(View view) {
        ...
        startActivity(new Intent(this, SelectPersonActivity.class));
        finish();
    }
...
//            if (apiError.getMessage().equals("getTypeChange")) {
...
//            }
    ...
    public void showProgress() {
        ...
        if (SendDocumentActivity.this.isFinishing()) {
            return;
        }
