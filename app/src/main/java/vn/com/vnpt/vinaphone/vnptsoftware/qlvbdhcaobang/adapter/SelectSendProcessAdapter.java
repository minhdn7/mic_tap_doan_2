    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (sizes.get(position) > 0) {
            ...
            if (!touchs.get(position)) {
                ...
                SelectSendProcessAdapter selectSendNotifyAdapter = new SelectSendProcessAdapter(context, R.layout.item_person_send_process_list,
                        R.layout.item_person_send_process_detail, lst, sizes, touchs, type);
...
//                                    View view1 = personSendNotifyChecks.get(i).getView();
//                                    CheckBox check = (CheckBox) view1.findViewById(R.id.checkDongXL);
...
//                                    CheckBox check = (CheckBox) view1.findViewById(R.id.checkDongXL);
//                                    RadioButton checkXLChinh = (RadioButton) view1.findViewById(R.id.checkXLChinh);
//                                    if (checkXLChinh.isChecked() && check.isEnabled()) {
//                                        checkXLChinh.setChecked(false);
//                                    }
//                                    if (check.isEnabled()) {
