...
import vn.com.vnpt.vinaphone.vnptsoftware.qlvbdhcaobang.view.activity.ForwardChiDaoActivity;
import vn.com.vnpt.vinaphone.vnptsoftware.qlvbdhcaobang.view.activity.ReplyChiDaoActivity;
...
//                            countUsers.add(countUser);
//                        }
//                        PersonChiDaoAdapter contactAdapter = new PersonChiDaoAdapter(context, R.layout.item_person_chidao_list_sub, R.layout.item_person_chidao_detail, R.layout.item_person_chidao_list_detail, subContacts, sizes, countUsers);
//                        int adapterCount = contactAdapter.getCount();
//                        for (int i = 0; i < adapterCount; i++) {
//                            View item = contactAdapter.getView(i, null, null);
//                            layoutContact.addView(item);
...
//            checkChon.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
//                @Override
...
//                                if (!chons.contains(lst.get(i)))
//                                chons.add(lst.get(i));
//                            }
//                    } else {
//                        for (int i = 0; i < lst.size(); i++) {
//                            chons.remove(lst.get(i));
//                        }
//                    }
//                    emails.setEmails(chons);
//                    EventBus.getDefault().postSticky(emails);
...
//                }
        ...
        if (personChiDaoChecks.size() == personChiDaoAllList.size()) {
            switch (type) {
                case "SEND":
                    ((SendChiDaoActivity) context).showContact();
                    break;
                case "EDIT":
                    ((EditChiDaoActivity) context).showContact();
                    break;
                case "REPLY":
                    ((ReplyChiDaoActivity) context).showContact();
                    break;
                case "FW":
                    ((ForwardChiDaoActivity) context).showContact();
                    break;
            }
        }
        return view;
